...
class BonusScores
{
    static void Main()
    {
        ...
        switch (inputNum)
        {
            ...
            case 2:
            case 3:
                Console.WriteLine("Your bonus value is: {0}", inputNum * 10);
                break;

            case 4:
            case 5:
            case 6:
                Console.WriteLine("Your bonu value is: {0}", inputNum * 100);
                break;

            case 7:
            case 8:
            case 9:
                Console.WriteLine("Your bonus value is: {0}", inputNum * 1000);
                break;
